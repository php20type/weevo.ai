						...
						@if (auth()->user()->group == 'user')
								...
								<div class="row">
									<div class="form-group mb-2">
										<label class="custom-switch">
											<input type="checkbox" name="use-openai" class="custom-switch-input" @if ( auth()->user()->enable_openai_api_usage) checked @endif>
											<span class="custom-switch-indicator"></span>
											<span class="custom-switch-description">{{ __('Use Personal OpenAI Account') }}</span>
										</label>
									</div>
							...
							@if (config('settings.personal_sd_api') == 'allow')
								<div class="row">
									<div class="form-group mb-2">
										<label class="custom-switch">
											<input type="checkbox" name="use-sd" class="custom-switch-input" @if ( auth()->user()->enable_sd_api_usage) checked @endif>
											<span class="custom-switch-indicator"></span>
											<span class="custom-switch-description">{{ __('Use Personal Stable Diffusion Account') }}</span>
										</label>
									</div>
